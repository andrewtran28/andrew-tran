    ...
    <>
      ...
      <div className="about-cont">
        ...
        <p>
          ...
          videos, or gaming. That being said, I tend to keep my space{" "}
          <strong>organized and minimal</strong>. This is how I like everything
          to be in general. The following selection is a selection of my setup
          for web development.
          <ul></ul>
        </p>
        <p>
